...
# Initialize Figure
f = figure(1)
bug_plot = plot(bug.x, bug.y, 'ko') # Vehicle
food_plot = plot(foodx, foody, 'b*') # Food
pred_plot = plot(predx, predy, 'r*') # Predator
sr_plot = plot([0], [0], 'w')
sl_plot = plot([0], [0], 'w')
...
run(10000*ms,report='text') # Run 10 seconds of simulation time
